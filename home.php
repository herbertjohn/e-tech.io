...
<div class="section-title">
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="section-title">
          <h2>Contato</h2>
          <p>Entre em contato e tire suas dúvidas e peça um orçamento!</p>
        </div>
      </div>
            ...
            <form action="https://formspree.io/moqkklln" method="post" role="form" class="php-email-form">
              <div class="form-row">
                <div class="col-md-6 form-group">
                  <input type="text" name="nome" class="form-control" id="nome" placeholder="Nome" data-rule="minlen:4" data-msg="Digite pelo menos 4 caracteres" />
              ...
              <div class="form-group">
                <textarea class="form-control" name="messagem" id="mensagem" rows="5" data-rule="required" data-msg="Por favor escreva algo para nós" placeholder="Mensagem"></textarea>
                <div class="validate"></div>
              </div>
              <div class="mb-3">
